...
MASTER_COLUMNS_PREMI = {
    ...
    "buanaindependent": [
        ...
        "cedants_share",
        "spreading_of_risk_or",
        "spreading_of_risk_qs",
        "spreading_of_risk_surplus",
        "spreading_of_risk_others",
        "premium_100",
        "premium_rate",
    ...
    "askrida": [
        ...
        "nilai_pertanggungan",
        "premi_original",
        "premi_reinsurer_share",
        "premi_indore_share",
        "currency",
        "reff_of_no_bordereaux",
        "100_reinsurer_sum_insured",
        "100_reinsurer_ri_comm",
        "100_reinsurer_netto",
        "reindo_sum_insured",
        "reindo_ri_comm",
        "reindo_netto",
...
MASTER_COLUMNS_CLAIM = {
    "aca": [
        ...
        "period_of_insurance_start",
        "period_of_insurance_end",
        "start_period_master_policy",
        "date_of_loss",
        "cause_of_loss",
        "claim_event",
        "our_share_percent",
        "reinsurer_share_percent",
        "claim_amount_100",
        "reinsurance_claim",
        "object_info_1",
        "object_info_2",
    ...
    "buanaindependent": [
        ...
        "zip_code",
        "dol",
        "source_direct_coins_inward_fac",
        "curr",
        "claim_100",
        "cedants_share_percent",
        "cedants_share_in_amount",
        "spreading_of_claim_or",
        "spreading_of_claim_qs",
        "spreading_of_claim_surplus",
        "spreading_of_claim_others",
        "paid_claims_treaty_share",
        "outstanding_claims_treaty_share",
        "note",
        "period",
    ],
    "tripakarta": [
        ...
        "spreading_of_claim_or",
        "spreading_of_claim_qs",
        "spreading_of_claim_spl",
        "spreading_of_claim_others",
        "claim_qs_marsh_re_share",
        "claim_spl_marsh_re_share",
        "os_claims_100",
        "os_claims_marsh_re_share",
        "note",
        "period",
    ],
    "askrida": [
    ...
    "jamkridajabar": [
        ...
        "tanggal_lahir",
        "pelaporan_bordero_premi",
        "date_of_loss",
        "cause_of_loss",
        "pokok_kredit_plafond",
        "klaim_100",
        "bagian_bank_retensi",
        "bagian_penjaminan_asuransi",
        "bagian_nasional_re",
        "bagian_riu",
        "skim",
